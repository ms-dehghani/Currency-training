...
class ServiceRepositoryImplTest {
    ...
    fun givenComicID_WhenGetComicByIdInvoked_ThenExpectedComicsItemReturned() = runBlocking {
        ...
        val expectedComicItem = CurrencyRateItem(
            id = 1,
            title = "title",
    ...
    fun givenPagingSource_WhenLoadInvoked_ThenExpectedComicListReturned() = runBlocking {
        ...
        val mockPagingSource = object : PagingSource<Int, CurrencyRateItem>() {
            override suspend fun load(params: LoadParams<Int>): LoadResult<Int, CurrencyRateItem> {
            ...
            override fun getRefreshKey(state: PagingState<Int, CurrencyRateItem>): Int {
                return 0
            }
        }
